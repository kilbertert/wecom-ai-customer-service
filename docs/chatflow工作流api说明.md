...
POST
/chat-messages
curl -X POST 'https://ai.trendpower.cc/v1/chat-messages' \
...
当 Advanced Chat 因 Human-in-the-Loop 暂停时，event 会变为 workflow_paused。 响应仍然包含 message_id、conversation_id、answer 和 workflow_run_id，并且 data 中会新增 paused_nodes 和 reasons。 对于 human_input_required，每个 reason 都会包含 form_id 和 expiration_time。
...
POST
/files/upload
curl -X POST 'https://ai.trendpower.cc/v1/files/upload' \
--header 'Authorization: Bearer {api_key}' \
...
GET
/end-users/:end_user_id
curl -X GET 'https://ai.trendpower.cc/v1/end-users/6ad1ab0a-73ff-4ac1-b9e4-cdb312f71f13' \
--header 'Authorization: Bearer {api_key}'
...
GET
/files/:file_id/preview
curl -X GET 'https://ai.trendpower.cc/v1/files/72fa9618-8f89-4a37-9b33-7e1178a24a67/preview' \
--header 'Authorization: Bearer {api_key}'
...
curl -X GET 'https://ai.trendpower.cc/v1/files/72fa9618-8f89-4a37-9b33-7e1178a24a67/preview?as_attachment=true' \
--header 'Authorization: Bearer {api_key}' \
...
POST
/chat-messages/:task_id/stop
curl -X POST 'https://ai.trendpower.cc/v1/chat-messages/:task_id/stop' \
...
GET
/form/human_input/:form_token
curl -X GET 'https://ai.trendpower.cc/v1/form/human_input/{form_token}' \
--header 'Authorization: Bearer {api_key}'
...
POST
/form/human_input/:form_token
curl -X POST 'https://ai.trendpower.cc/v1/form/human_input/{form_token}' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
"inputs": {"answer": "已确认答案"},
...
Response
Server-Sent Events 流（text/event-stream）。 常见事件包括 workflow_paused、node_started、node_finished、human_input_form_filled、human_input_form_timeout、workflow_finished。 如果调用该接口时工作流已经结束，服务端会立即返回单个完成事件。

Request
GET
/workflow/:task_id/events
curl -N -X GET 'https://ai.trendpower.cc/v1/workflow/{workflow_run_id}/events?user=abc-123&amp;continue_on_pause=true' \
--header 'Authorization: Bearer {api_key}'
...
POST
/messages/:message_id/feedbacks
curl -X POST 'https://ai.trendpower.cc/v1/messages/:message_id/feedbacks' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "rating": "like",
...
GET
/app/feedbacks
curl -X GET 'https://ai.trendpower.cc/v1/app/feedbacks?page=1&amp;limit=20' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json'
...
GET
/messages/{message_id}/suggested
curl --location --request GET 'https://ai.trendpower.cc/v1/messages/{message_id}/suggested?user=abc-123' \
...
GET
/messages
curl -X GET 'https://ai.trendpower.cc/v1/messages?user=abc-123&amp;conversation_id={conversation_id}'
--header 'Authorization: Bearer {api_key}'
...
GET
/conversations
curl -X GET 'https://ai.trendpower.cc/v1/conversations?user=abc-123&amp;last_id=&amp;limit=20' \
--header 'Authorization: Bearer {api_key}'
...
DELETE
/conversations/:conversation_id
curl -X DELETE 'https://ai.trendpower.cc/v1/conversations/{conversation_id}' \
--header 'Content-Type: application/json' \
...
POST
/conversations/:conversation_id/name
curl -X POST 'https://ai.trendpower.cc/v1/conversations/{conversation_id}/name' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer {api_key}' \
--data-raw '{
  "name": "",
...
GET
/conversations/:conversation_id/variables
curl -X GET 'https://ai.trendpower.cc/v1/conversations/{conversation_id}/variables?user=abc-123' \
--header 'Authorization: Bearer {api_key}'

Copy
Copied!
带变量名过滤的请求
curl -X GET 'https://ai.trendpower.cc/v1/conversations/{conversation_id}/variables?user=abc-123&amp;variable_name=customer_name' \
--header 'Authorization: Bearer {api_key}'
...
PUT
/conversations/:conversation_id/variables/:variable_id
curl -X PUT 'https://ai.trendpower.cc/v1/conversations/{conversation_id}/variables/{variable_id}' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer {api_key}' \
--data-raw '{
  "value": "Updated Value",
...
POST
/audio-to-text
curl -X POST 'https://ai.trendpower.cc/v1/audio-to-text' \
--header 'Authorization: Bearer {api_key}' \
...
POST
/text-to-audio
curl -o text-to-audio.mp3 -X POST 'https://ai.trendpower.cc/v1/text-to-audio' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
...
GET
/info
curl -X GET 'https://ai.trendpower.cc/v1/info' \
-H 'Authorization: Bearer {api_key}'
...
GET
/parameters
curl -X GET 'https://ai.trendpower.cc/v1/parameters'
...
GET
/meta
curl -X GET 'https://ai.trendpower.cc/v1/meta' \
-H 'Authorization: Bearer {api_key}'
...
GET
/site
curl -X GET 'https://ai.trendpower.cc/v1/site' \
-H 'Authorization: Bearer {api_key}'
...
GET
/apps/annotations
curl --location --request GET 'https://ai.trendpower.cc/v1/apps/annotations?page=1&amp;limit=20' \
--header 'Authorization: Bearer {api_key}'
...
POST
/apps/annotations
curl --location --request POST 'https://ai.trendpower.cc/v1/apps/annotations' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "question": "What is your name?",
...
PUT
/apps/annotations/{annotation_id}
curl --location --request PUT 'https://ai.trendpower.cc/v1/apps/annotations/{annotation_id}' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "question": "What is your name?",
...
DELETE
/apps/annotations/{annotation_id}
curl --location --request DELETE 'https://ai.trendpower.cc/v1/apps/annotations/{annotation_id}' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json'
...
POST
/apps/annotation-reply/{action}
curl --location --request POST 'https://ai.trendpower.cc/v1/apps/annotation-reply/{action}' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "score_threshold": 0.9,
...
GET
/apps/annotations
curl --location --request GET 'https://ai.trendpower.cc/v1/apps/annotation-reply/{action}/status/{job_id}' \
--header 'Authorization: Bearer {api_key}'
